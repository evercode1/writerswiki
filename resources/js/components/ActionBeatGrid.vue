<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1">ActionBeat</h1>
                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                ...
                                <a v-bind:href="'/action-beat/' + row.Id + '-' + row.Slug"> {{ row.Name }}</a>
                            ...
                            <td >
                                ...
                                <a v-bind:href="'/action-beat/' + row.Id + '/edit'">
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/action-beat-data', this);
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/action-beat-data', this);
            ...
            confirmDelete: function(id){
                ...
                if(confirm("Are you sure you want to delete?")){
                    ...
                    axios.post('/action-beat-delete/' + id)
                            .then(response => {
