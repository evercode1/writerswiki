...
namespace App\Console\Commands\Templates\GeneratorTemplates;



class GeneratorTemplateAssembler
{
    ...
    public function assembleTemplate($template)
    {
        ...
        if (file_exists(base_path(). '/app/Templates')){
            ...
            $file = base_path(). '/app/Templates/GeneratorTemplates/templates/' . $template . '.txt';
