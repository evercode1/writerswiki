<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1">All Channels</h1>
                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                ...
                                <a v-bind:href="'/channel-list/' + row.Name"> {{ row.Name }}</a>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/all-channels-data', this);
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/all-channels-data', this);
