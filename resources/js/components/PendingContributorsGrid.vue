<template>
    ...
    <div class="row">
        ...
        <div>
            ...
            <h1 class="flow-text grey-text text-darken-1">Pending Contributors</h1>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('api/pending-contributor-data', this);
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, 'api/pending-contributor-data', this);
