                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                ...
                                <a v-bind:href="'/channel/' + row.Id + '-' + row.Slug"> {{ row.Name }}</a>
                            ...
                            <td >
                                ...
                                <a v-bind:href="'/channel/' + row.Id + '/edit'">
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/channel-data', this);

        },
        data: function () {
            return {
                query: '',
                gridColumns: ['Id', 'Name', 'Description', 'Active', 'Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/channel-data', this);
