    ...
    export default {
        ...
        data: function () {
            return {
                ...
                sortOrder: 1,
                sortKey: 'created_at',
                createUrl: '/not-real-link/create-preset/' + this.type,
        ...
        methods: {
            ...
            getData: function (request){
                ...
                switch (request){
                    ...
                    case this.query :
                        ...
                        getPage = '/api/all-channel-links-data/' + this.author + '?' +
                                'keyword=' + this.query +
                                '&column=' + name +
                                '&direction=' + this.sortOrder;
                ...
                if (this.query == '' && getPage != null){
                    ...
                    if (getPage != null){
                        ...
                        $.getJSON(getPage, function (data) {
                            ...
                            this.first_page_url = '/api/all-channel-links-data/' + this.author + '?page=1&keyword=' +this.query;
                            this.last_page_url = '/api/all-channel-links-data/' + this.author + '?page=' + this.last_page + '&keyword=' +this.query;
                            this.current_page = data.current_page;
            ...
            loadData: function (){
                $.getJSON('/api/all-channel-links-data/' + this.author, function (data) {
                    this.gridData = data.data;
                    this.total = data.total;
                    this.last_page =  data.last_page;
                    this.next_page_url = data.next_page_url;
                    this.prev_page_url = data.prev_page_url;
                    this.current_page = data.current_page;
                    this.first_page_url = '/api/all-channel-links-data/' + this.author + '?page=1';
                    this.last_page_url = '/api/all-channel-links-data/' + this.author + '?page=' + this.last_page;
                    this.setPageNumbers();
                }.bind(this));
            },
