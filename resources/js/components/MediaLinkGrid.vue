<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1">Media Link</h1>
                ...
                <table>
                    ...
                    <tr v-for="row in gridData">
                        ...
                        <td >
                            ...
                            <a v-bind:href="'/media-link/' + row.Id + '/edit'">
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/media-link-data', this);

        },
        data: function () {
            return {
                query: '',
                gridColumns: ['Id', 'Type', 'Name', 'Author', 'Category',
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/media-link-data', this);
            ...
            confirmDelete: function(id){
                ...
                if(confirm("Are you sure you want to delete?")){
                    ...
                    axios.post('/media-link-delete/' + id)
                         .then(response => {
