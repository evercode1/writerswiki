                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td >
                                ...
                                <a v-bind:href="'/emotion/' + row.Id + '/edit'">
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/emotion-data', this);
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/emotion-data', this);
