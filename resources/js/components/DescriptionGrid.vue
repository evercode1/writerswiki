<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1">Descriptions</h1>
                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                ...
                                <a v-bind:href="'/description/' + row.Id + '-' + row.Slug"> {{ row.Name }}</a>
                            ...
                            <td >
                                ...
                                <a v-bind:href="'/description/' + row.Id + '/edit'">
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/description-data', this);
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/description-data', this);
            ...
            confirmDelete: function(id){
                ...
                if(confirm("Are you sure you want to delete?")){
                    ...
                    axios.post('/description-delete/' + id)
                            .then(response => {
