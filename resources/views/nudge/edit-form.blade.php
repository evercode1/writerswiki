...
<!-- name input -->
    ...
    <!-- is_active select -->
            ...
            <div class="{{ $errors->has('is_active') ? ' has-error' : '' }}">
                ...
                <select id="is_active" name="is_active">
                    ...
                    <option value="{{ $nudge->is_active }}">{{ $nudge->is_active == 1 ? 'Yes' : 'No' }}</option>

                    @if($nudge->is_active == 1)
    ...
    <!-- description input -->
        ...
        <div class="{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <textarea id="description" name="body">{!! $nudge->description !!}</textarea>
