            ...
            <li class="bold waves-effect active"><a class="collapsible-header">Pages<i class="material-icons chevron">chevron_left</i></a>
                <div class="collapsible-body">
                    <ul>
                        ...
                        <li><a href="/all-stars" class="waves-effect">Emotions<i class="material-icons">star</i></a></li>
                        <li><a href="/all-planets" class="waves-effect">Action Beats<i class="material-icons">star</i></a></li>
                        <li><a href="/all-planets" class="waves-effect">Descriptions<i class="material-icons">star</i></a></li>
