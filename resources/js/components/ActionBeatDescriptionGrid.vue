<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1">Action Beat Description</h1>
                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td >
                                ...
                                <a v-bind:href="'/action-beat-description/' + row.Id + '/edit'">
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                query: '',
                gridColumns: ['Id', 'label', 'Active', 'Action', 'Contributor', 'Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
        ...
        methods: {
            ...
            getData: function (request){
                ...
                switch (request){
                    ...
                    case this.query :
                        ...
                        getPage = 'api/action-beat-description-data?' +
                                'keyword=' + this.query +
                                '&column=' + name +
                                '&direction=' + this.sortOrder;
            ...
            confirmDelete: function(id){
                ...
                if(confirm("Are you sure you want to delete?")){
                    ...
                    axios.post('/action-beat-description-delete/' + id)
                            .then(response => {
