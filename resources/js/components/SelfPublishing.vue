<template>
    ...
    <div class="row">
        ...
        <h1 class="flow-text grey-text text-darken-1 capitalize">All Self-Publishing</h1>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/self-publishing-data', this);
        ...
        data: function () {
            return {
                query: '',
                gridColumns: ['Type','Title', 'Author', 'Subcategory', 'Contributor'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/self-publishing-data', this);
