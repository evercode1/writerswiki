                    ...
                    <table>
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td>
                                ...
                                <a v-bind:href="'/subcategory/' + row.Id + '-' + row.Slug"> {{ row.Name }}</a>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            gridData.loadData('/api/subcategory-data', this);

        },
        data: function () {
            return {
                query: '',
                gridColumns: ['Id', 'Name', 'Category', 'Active', 'Created'],
                gridData: [],
                total: null,
                next_page_url: null,
                prev_page_url: null,
        ...
        methods: {
            ...
            getData:  function(request){
                ...
                gridData.getQueryData(request, '/api/subcategory-data', this);
            ...
            confirmDelete: function(id){
                ...
                if(confirm("Are you sure you want to delete?")){
                    ...
                    axios.post('/subcategory-delete/' + id)
                            .then(response => {
